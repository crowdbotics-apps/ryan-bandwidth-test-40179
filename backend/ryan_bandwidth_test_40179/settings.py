"""
Django settings for ryan_bandwidth_test_40179 project.
...
ROOT_URLCONF = 'ryan_bandwidth_test_40179.urls'
...
WSGI_APPLICATION = 'ryan_bandwidth_test_40179.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ryan_bandwidth_test_40179 API",
    "DESCRIPTION": "API documentation for ryan_bandwidth_test_40179 App",
    "VERSION": "v1",
}
