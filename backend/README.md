...
## Project Structure
    ...
    ├── ryan_bandwidth_test_40179  # Django project configurations
...
1. Clone this repo and `cd ryan_bandwidth_test_40179`
...
2. Clone this repo and `cd ryan_bandwidth_test_40179`
